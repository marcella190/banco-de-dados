...
CREATE VIEW vw_relatorio_comercial AS SELECT a.nm_assinante, t.n_fone FROM Assinante a JOIN Telefone t ON a.cd_assinante = t.cd_assinante JOIN Endereco e ON a.cd_assinante = e.cd_assinante JOIN Municipio m ON e.cd_municipio = m.cd_municipio WHERE m.ds_municipio IN ('Natal', 'João Câmara');
